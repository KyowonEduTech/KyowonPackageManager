...
2) Unity Package Manager 로 KyowonPackageManager 를 설치해 주세요.
   https://github.com/KyowonEduTech/KyowonPackageManager.git#develop 로 설치할 수 있습니다.
...
5) 모듈은 KyowonPackageManifest.json 파일과 .gitignore 파일로 관리됩니다.
   ...
   프로젝트를 Git 에 올릴 때, 해당 파일을 꼭 추가하여 Commit 해주세요. 다른 팀원은 해당 파일들만 받으면 해당 모듈 버전으로 자동 설치 및 관리됩니다.
